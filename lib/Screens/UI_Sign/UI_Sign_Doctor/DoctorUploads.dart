...
/*class DoctorUploads extends StatefulWidget {
  const DoctorUploads({Key? key}) : super(key: key);

  @override
  State<DoctorUploads> createState() => _DoctorUploadsState();
}

class _DoctorUploadsState extends State<DoctorUploads> {
...
class DoctorFiles extends StatefulWidget {
  const DoctorFiles({Key? key}) : super(key: key);

  @override
  State<DoctorFiles> createState() => _DoctorFilesState();
}

signup_doctor_in_firebase(context) async {
  try {
    loading(context);
...
put_doctor_date_into_firebase({
  ...
  required int city,
  required String doctor_info_ar,
  required String title,
  required String professional_title_ar,
  required String doctor_affiliation_ar,
  required String category,
  required String clinic_name_ar,
  required String clinic_description_ar,
  required String clinic_address_ar,
  required String clinic_phone,
  // required String doctor_vezeta,
  required String doctor_info_en,
  required String professional_title_en,
  required String doctor_affiliation_en,
  required String clinic_name_en,
  required String clinic_description_en,
  required String clinic_address_en,
...
class _DoctorFilesState extends State<DoctorFiles> {
                  ...
                  onPressed: () async {
                    if (file != null && lice != null) {
                      UserCredential response =
                          await signup_doctor_in_firebase(context);
                      if (response.user != null) {
                        put_doctor_date_into_firebase(
                           ...
                           doctor_info_ar: doctorInfoar.text,
                           doctor_info_en: doctorInfoen.text,
                            title: professionalTitleValuedoc!,
                            professional_title_ar: professionalTitlear.text,
                            professional_title_en: professionalTitleen.text,
                            doctor_affiliation_ar: educationalQualificationar.text,
                            doctor_affiliation_en: educationalQualificationen.text,
                            clinic_name_ar: clinicNameController.text,
                            clinic_name_en: clinicNameControlleren.text,
                            clinic_address_ar: clinicAddController.text,
                            clinic_address_en: clinicAddControlleren.text,
                            clinic_description_ar: aboutClinicController.text,
                            clinic_description_en: aboutClinicControlleren.text,
                            clinic_phone: clinicPhoneController.text,
                            category: selectedValue!,
                            // doctor_vezeta: examinationFeesValue!,
