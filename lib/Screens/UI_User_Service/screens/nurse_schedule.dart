...
class nursschedule extends StatefulWidget {
  NurseModel nurse;
  nursschedule({Key? key, required this.nurse}) : super(key: key);

  @override
  State<nursschedule> createState() => _nursscheduleState();
}

var appcontroller = Get.put(Appcontroller());

class _nursscheduleState extends State<nursschedule> {
  @override
  void initState() {
    super.initState();
    appcontroller.getappointmet(widget.nurse.userid);
  }
                                ...
                                child: Row(
                                  children: [
                                    GestureDetector(
                                        ...
                                        child:
                                            TaskTile(appcontroller.applist[i])
                                        /* child: Container(
